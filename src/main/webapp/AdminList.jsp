	...
	<div class="wrapper-content">
		<div class="header-btn">
			...
			<form class="search-form"
				action="<%=request.getContextPath()%>/Admin/search" method="post">
				<input type='text' name='value' placeholder='Enter Text Search'
					class="search">
			...
			<table class="data" width='100%'>
				...
				<tbody>
					...
					<tr>
						...
						<td><a
							href="<%=request.getContextPath()%>/Admin/delete?id=<%=adminList.get(i).getId_person()%>"><button
									type="button">
				...
				<div class="modal-body">
					<div class="modal-form">
						<form action="<%=request.getContextPath()%>/Admin/add"
							method="post">
							<label for="name" class="modal-label">Tên Admin</label> <br>
							<input type="text" name="name" placeholder="Nhập tên admin"
								class="modal-input" required />
							</td> <label for="password" class="modal-label">Mật Khẩu</label> <br>
							<input type="password" name="password"
								placeholder="Nhập password" class="modal-input" required />
							</td> <label for="phone" class="modal-label">SĐT</label> <br> <input
								type="text" name="phone" placeholder="Nhập SĐT"
								class="modal-input" required /> <label for="email"
								class="modal-label">Email</label> <br> <input type="text"
								name="email" placeholder="Nhập email" class="modal-input"
								required /> <label for="cccd" class="modal-label">CCCD/CMND</label>
							<br> <input type="text" name="cccd"
								placeholder="Nhập CCCD/CMND" class="modal-input" required /> <label
								for="gender" class="modal-label">Giới Tính</label> <br> <select
								name="gender" class="modal-option">
							...
							<input type="text" name="address" placeholder="Nhập địa chỉ"
								...
								class="modal-input" required /> <label for="salary"
								class="modal-label">Lương</label> <br> <input type="text"
								name="salary" placeholder="Nhập lương" class="modal-input"
								required />
