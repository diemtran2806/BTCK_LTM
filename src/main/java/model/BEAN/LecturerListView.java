...
public class LecturerListView  extends Person {
	...
	public LecturerListView(int id_person, String name, String password, String role, String phone, String email,
			String CCCD, boolean gender, String address, Date dob, String faculty_name, int lecturer_salary) {
		super(id_person, name, password, role, phone, email, CCCD, gender, address, dob);
